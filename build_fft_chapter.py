...
def main():
    ...
    TRANSCRIPT_PATH = f"source_media/fft/{CHAPTER_NAME}.txt"
    AUDIO_PATH = f"source_media/fft/{CHAPTER_NAME}.mp3"
    CLIPS_DIR = f"fft/{CHAPTER_NAME}/clips"
    OUTPUT_JSON = f"fft/{CHAPTER_NAME}/segments.json"

    os.makedirs(f"fft/{CHAPTER_NAME}", exist_ok=True)
